...
$(window).on('scroll',function(){counter();});$(window).scroll(function(){if($(document).scrollTop()>50){$('.navigation').addClass('onscroll');}else{$('.navigation').removeClass('onscroll');}});if($(document).scrollTop()>50){$('.navigation').addClass('onscroll');}else{$('.navigation').removeClass('onscroll');}
$(".navbar-toggler").click(function(){if($("#navigation").hasClass("show")==false){$("body").addClass("nav-shown");}else{$("body").removeClass("nav-shown");}});if($(document).width()<768){$('#navigation a').on('click',function(){$('.navbar-collapse').collapse('hide');$("body").removeClass("nav-shown");});}});